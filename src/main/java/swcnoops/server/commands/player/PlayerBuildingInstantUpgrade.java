...
public class PlayerBuildingInstantUpgrade extends PlayerChecksum<PlayerBuildingInstantUpgrade, CommandResult> {
    ...
    @Override
    protected PlayerBuildingInstantUpgrade parseArgument(JsonParser jsonParser, Object argumentObject) {
        return jsonParser.fromJsonObject(argumentObject, PlayerBuildingInstantUpgrade.class);
    }

    @Override
    public String getAction() {
        return "player.building.instantUpgrade";
    }
