...
public class PlayerBuildingUpgradeAll extends AbstractCommandAction<PlayerBuildingUpgradeAll, CommandResult> {
    ...
    protected CommandResult execute(PlayerBuildingUpgradeAll arguments, long time) throws Exception {
        ...
        playerSession.buildingUpgradeAll(arguments.getBuildingUid(), time);
